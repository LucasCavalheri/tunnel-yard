...
const MESSAGES: &[(&str, &str, &str)] = &[
    ...
    ("boot.bridgeMissing", "Could not start My VPNs. Run `my-vpns --smoke` from a terminal to see the error.", "Não foi possível iniciar o My VPNs. Rode `my-vpns --smoke` no terminal para ver o erro."),
    ("brand.subtitle", "OpenForti control desk", "Mesa de controle OpenForti"),
    ("brand.subtitleMulti", "OpenForti control desk · multi-link", "Mesa de controle OpenForti · multi-link"),
    ("status.linkUp", "LINK UP", "LINK UP"),
    ("status.handshake", "HANDSHAKE", "HANDSHAKE"),
    ("status.fault", "FAULT", "FALHA"),
    ("status.idle", "IDLE", "OCIOSO"),
    ("ops.autoRelink", "Auto-relink", "Auto-reconectar"),
    ("ops.reloadProfiles", "Reload profiles", "Recarregar perfis"),
    ("ops.killAll", "Kill all links", "Derrubar todos"),
    ...
    ("ops.desk", "Desk", "Mesa"),
    ("ops.noneActive", "none active", "nenhuma ativa"),
    ("ops.deskSummary", "{up} up · {handshake} handshake", "{up} ativas · {handshake} handshake"),
    ("ops.newProfile", "New profile", "Novo perfil"),
    ("ops.importConf", "Import .conf", "Importar .conf"),
    ("ops.quit", "Quit", "Sair"),
    ("ops.quitConfirm", "Quit My VPNs?", "Sair do My VPNs?"),
    ...
    ("notify.parkedTitle", "My VPNs is still running", "O My VPNs continua em execução"),
    ...
    ("profiles.killLink", "Kill link", "Desligar"),
    ...
    ("setup.needsClient", "My VPNs needs {engine} to open SSL tunnels. Your operating system:", "O My VPNs precisa do {engine} para abrir túneis SSL. Seu sistema:"),
    ...
    ("tray.show", "Show My VPNs", "Mostrar My VPNs"),
    ...
    ("notify.updateTitle", "My VPNs update available", "Atualização do My VPNs disponível"),
    ("notify.updateBody", "Version {latest} is out (you have {current}). Open My VPNs to install it.", "Saiu a versão {latest} (você tem {current}). Abra o My VPNs para instalar."),
    ...
    ("update.installTitle", "Install My VPNs update", "Instalar atualização do My VPNs"),
