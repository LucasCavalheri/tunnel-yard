...
| File | Distro family |
|------|----------|
| `tunnel-yard_3.0.7_amd64.deb` | Debian, Ubuntu, Mint, Pop!_OS, Kali, Raspberry Pi OS, … |
| `tunnel-yard-3.0.7-1.x86_64.rpm` | Fedora, RHEL, Rocky, Alma, openSUSE, Mageia, … |
| `tunnel-yard-3.0.7-1-x86_64.pkg.tar.zst` | Arch, Manjaro |
| `tunnel-yard-3.0.7-r0-x86_64.apk` | Alpine (needs `gcompat`) |
...
sudo apt install ./tunnel-yard_3.0.7_amd64.deb

# Fedora / RHEL / Rocky / Alma
sudo dnf install ./tunnel-yard-3.0.7-1.x86_64.rpm

# Arch / Manjaro
sudo pacman -U ./tunnel-yard-3.0.7-1-x86_64.pkg.tar.zst

# Alpine
sudo apk add gcompat
sudo apk add --allow-untrusted ./tunnel-yard-3.0.7-r0-x86_64.apk
